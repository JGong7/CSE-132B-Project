...
<html>
<head>
    <title>Master Degree Requirement Check</title>
    <style>
        form {
            margin: 20px;
            padding: 20px;
...
<body>
    <h2>Master Degree Requirement Check</h2>
    <form action="../../process_query/display_ms_degreeCheck.jsp" method="GET">
        <div class="input-group">
            <label for="studentId">Select a Master Student:</label>
            <select id="studentId" name="studentId">
                <option value="">Select a Master student</option>
                <% 
                    ...
                    try {
                        ...
                        String query = "SELECT s.student_id, s.ssn, s.first_name, s.middle_name, s.last_name " +
                                        "FROM Student s " +
                                        "LEFT JOIN Master_student m ON s.student_id = m.student_id " +
                                        "LEFT JOIN Bsms_student b ON s.student_id = b.student_id " +
                                        "WHERE m.student_id IS NOT NULL OR b.student_id IS NOT NULL";
        ...
        <div class="input-group">
            ...
            <select id="degreeId" name="degreeId">
                ...
                <% 
                    try {
                        String degreeQuery = "SELECT degree_id, degree_name, type FROM Degree WHERE type = 'M.S.'";
